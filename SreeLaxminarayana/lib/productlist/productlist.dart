...
import 'package:ims/productlist/productgallery.dart';
                      ...
                      ? GridView.builder(
                         ...
                         //   mainAxisSpacing: 10.0,
                          ...
                          itemBuilder: (BuildContext context, int index) {
                           //{
                           //   print("lemgth" +  _productlist[index]['galleryitems']  .length  .toString());
                                     // print("imggg"+i.toString());
                                      //print("imggg"+_productlist[index]['galleryitems'][i]['gallery_image']);
                              return Container(
                              //  height: 1000.0,
                                //width: screenWidth/2,
                                child: Column(
                                    ...
                                    Padding(
                                      ...
                                      child: Card(
                                        ...
                                        child: InkWell(
                                          onTap: (){
                                              Navigator.of(context).pushReplacement(new MaterialPageRoute(
            builder: (BuildContext context) => new ProductimagegalleryScreen(
              category_name:_productlist[index] ['category_title'].toString(),
            )));
                                          },
                            ...
                            // width: screenWidth/2,
                                            child: Flexible(
                                              child: Image.network( "https://humbletree.in/sales/storage/uploads/gallery/" +
                                                             _productlist[index]
                                                                         ['galleryitems'][0]
                                                                     ['category_id']
                                                                 .toString() +
...
Text(_productlist[index] ['category_title'])                                  ],
                                ),
                              );
                        //    }
                              ...
                              child: GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Card(
                                    ...
                                    child: Row(
                                      children: [
                                                                                         Image.network("https://humbletree.in/sales/storage/uploads/gallery/2/image20220126071103000000.png"),
                                                                                                                                          Image.network("https://humbletree.in/sales/storage/uploads/gallery/2/image20220126071103000000.png")
,
