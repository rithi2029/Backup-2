...
import 'package:ims/leadlisting/search.dart';
              ...
              if (this.actionIcon.icon == Icons.search) {
                ...
                this.appBarTitle = new TextField(
                  ...
                  decoration: new InputDecoration(
                    suffixIcon:InkWell(child: Icon(Icons.search, color: Colors.white),
                    onTap: (){
searchinleadlist();
                    },
                    ) ,
...
*/
  ...
  void _handleSearchEnd() {
    setState(() {
      ...
      this.appBarTitle =
      new Text("Leads List", style: new TextStyle(color: Colors.white),);
      _IsSearching = false;
      _searchQuery.clear();
    });
  }
...
var resBody = json.decode(response.body);
  ...
  Widget appBarTitle = new Text("Leads List", style: new TextStyle(color: Colors.white),);
                              ...
                              children: <Widget>[
                                ...
                                GridView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      //   Navigator.pop(context);
                                      //print("_leadlist[index]['status']0"+_leadlist[index]['status'].toString());
